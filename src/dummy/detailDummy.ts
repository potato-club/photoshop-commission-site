...
export const DetailDummy: DetailType = {
  ...
  Comments: [
    ...
    },
    {
      ...
      Writer: '고잼',
      Date: new Date(2022, 4, 7, 3, 50),
      Text: '펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중...펼치기 구현 테스트중... 성공인가?',
      Good: 2,
      Bad: 1,
      Reply: [
